...
static FLOAT plr_fSpeedForward  = 7.0f;
static FLOAT plr_fSpeedBackward = 4.0f;
static FLOAT plr_fSpeedSide     = 7.0f;
static FLOAT plr_fSpeedUp       = 9.0f;
static FLOAT plr_fViewHeightStand  = 1.7f;
static FLOAT plr_fViewHeightCrouch = 0.5f;
